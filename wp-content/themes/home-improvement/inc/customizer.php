<?php
/**
 * Home Improvement theme  'home-improvement' Theme Customizer
 *
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'home_improvement_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'home_improvement_customize_partial_blogdescription',
			)
		);
	}
			   ...
			   $appreance_section_upsell_notice .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $header_section_upsell_notice .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $blog_section_upsell_notice .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $frontpage_section_upsell_notice .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $mobile_optimization_section_upsell_notice .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
   
			   $wp_customize->add_control(
				   new Home_Improvement_Custom_Text(
					   $wp_customize,
			   ...
			   $header_setting_description .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $wp_customize->add_control( new Home_Improvement_Custom_Text( $wp_customize, 'header_layout_upsell_message_setting', 
				   array(
			   ...
			   $blog_setting_description .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $wp_customize->add_control( new Home_Improvement_Custom_Text( $wp_customize, 'blog_layout_upsell_message_setting', 
				   array(
					   'label' => esc_html__( 'Get more features on Pro Version', 'home-improvement' ),
			   ...
			   $footer_setting_description .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $wp_customize->add_control( new Home_Improvement_Custom_Text( $wp_customize, 'footer_layout_upsell_message_setting', 
				   array(
					   'label' => esc_html__( 'Get more features on Pro Version', 'home-improvement' ),
			   ...
			   $footer_color_setting_description .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $wp_customize->add_control( new Home_Improvement_Custom_Text( $wp_customize, 'footer_color_upsell_message_setting', 
				   array(
					   'label' => esc_html__( 'Get more features on Pro Version', 'home-improvement' ),
					   'section' => 'colors',
			   ...
			   $home_improvement_pro_info_setting_description .='<span class="home-improvement-upgrade-pro"><a class="button" href="' . esc_url( 'https://alleythemes.com/home-improvement-wordpress-theme/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'home-improvement' ) . '</a></span>';
			   ...
			   $wp_customize->add_control( new Home_Improvement_Custom_Text( $wp_customize, 'site_info_upsell_message_setting', 
				   array(
 ...
 * @return void
 */
function home_improvement_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function home_improvement_customize_partial_blogdescription() {
 ...
 */
function home_improvement_customize_preview_js() {
	wp_enqueue_script( 'home-improvement-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), HOME_IMPROVEMENT_VERSION, true );
}
add_action( 'customize_preview_init', 'home_improvement_customize_preview_js' );
